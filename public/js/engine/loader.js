...
nx.onload = function() {
  ...
  if (
    maped_melody_arp !== NaN ||
    maped_melody_arp !== undefined ||
    maped_melody_arp !== null ||
    maped_melody_arp != undefined ||
    parsed_melody_arp != null
  ) {
  ...
  if (
    parsed_four_arp !== undefined ||
    parsed_four_arp !== null ||
    parsed_four_arp != undefined ||
    parsed_four_arp != null
  ) {
  ...
  if (
    parsed_eight_arp !== undefined ||
    parsed_eight_arp !== null ||
    parsed_eight_arp != undefined ||
    parsed_eight_arp != null
  ) {
  ...
  if (
    parsed_triplet_arp !== undefined ||
    parsed_triplet_arp !== null ||
    parsed_triplet_arp != undefined ||
    parsed_triplet_arp != null
  ) {
  ...
  if (
    parsed_sixteen_arp !== undefined ||
    parsed_sixteen_arp !== null ||
    parsed_sixteen_arp != undefined ||
    parsed_sixteen_arp != null
  ) {
  ...
  if (
    parsed_four_kick !== undefined ||
    parsed_four_kick !== null ||
    parsed_four_kick != undefined ||
    parsed_four_kick != null
  ) {
  ...
  if (
    parsed_eight_kick !== undefined ||
    parsed_eight_kick !== null ||
    parsed_eight_kick != undefined ||
    parsed_eight_kick != null
  ) {
    for (var i = 0; i <= parsed_four_kick.length - 1; i++) {
  ...
  if (
    parsed_triplet_kick !== undefined ||
    parsed_triplet_kick !== null ||
    parsed_triplet_kick != undefined ||
    parsed_triplet_kick != null
  ) {
    for (var i = 0; i <= parsed_four_kick.length - 1; i++) {
  ...
  if (
    parsed_sixteen_kick !== undefined ||
    parsed_sixteen_kick !== null ||
    parsed_sixteen_kick != undefined ||
    parsed_sixteen_kick != null
  ) {
    for (var i = 0; i <= parsed_four_kick.length - 1; i++) {
  ...
  if (
    parsed_four_snare !== undefined ||
    parsed_four_snare !== null ||
    parsed_four_snare != undefined ||
    parsed_four_snare != null
  ) {
  ...
  if (
    parsed_eight_snare !== undefined ||
    parsed_eight_snare !== null ||
    parsed_eight_snare != undefined ||
    parsed_eight_snare != null
  ) {
  ...
  if (
    parsed_triplet_snare !== undefined ||
    parsed_triplet_snare !== null ||
    parsed_triplet_snare != undefined ||
    parsed_triplet_snare != null
  ) {
  ...
  if (
    parsed_sixteen_snare !== undefined ||
    parsed_sixteen_snare !== null ||
    parsed_sixteen_snare != undefined ||
    parsed_sixteen_snare != null
  ) {
  ...
  if (
    parsed_four_hihat !== undefined ||
    parsed_four_hihat !== null ||
    parsed_four_hihat != undefined ||
    parsed_four_hihat != null
  ) {
  ...
  if (
    parsed_eight_hihat !== undefined ||
    parsed_eight_hihat !== null ||
    parsed_eight_hihat != undefined ||
    parsed_eight_hihat != null
  ) {
  ...
  if (
    parsed_triplet_hihat !== undefined ||
    parsed_triplet_hihat !== null ||
    parsed_triplet_hihat != undefined ||
    parsed_triplet_hihat != null
  ) {
  ...
  if (
    parsed_sixteen_hihat !== undefined ||
    parsed_sixteen_hihat !== null ||
    parsed_sixteen_hihat != undefined ||
    parsed_sixteen_hihat != null
  ) {
  ...
  if (
    parsed_eight_fx !== undefined ||
    parsed_eight_fx !== null ||
    parsed_eight_fx != undefined ||
    parsed_eight_fx != null
  ) {
  ...
  if (
    parsed_triplet_fx !== undefined ||
    parsed_triplet_fx !== null ||
    parsed_triplet_fx != undefined ||
    parsed_triplet_fx != null
  ) {
  ...
  if (
    parsed_sixteen_fx !== undefined ||
    parsed_sixteen_fx !== null ||
    parsed_sixteen_fx != undefined ||
    parsed_sixteen_fx != null
  ) {
